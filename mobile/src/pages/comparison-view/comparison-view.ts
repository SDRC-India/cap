...
export class ComparisonViewPage {
  ...
  */
  comapreArea() {
   ...
   selectedArea1= this.areaLevel1?(this.areaLevel1.stateAvailable?
    (this.areaLevel1.districtAvailable?this.district1:
   this.state1):ComparisonViewAreaFilterPipe.prototype.transform(this.area,this.areaLevel1,"GLO")[0]):null;

   selectedArea2= this.areaLevel2?(this.areaLevel2.stateAvailable?
    (this.areaLevel2.districtAvailable?this.district2:
   this.state2):ComparisonViewAreaFilterPipe.prototype.transform(this.area,this.areaLevel2,"GLO")[0]):null;

   selectedArea3= this.areaLevel3?(this.areaLevel3.stateAvailable?
    (this.areaLevel3.districtAvailable?this.district3:
   this.state3):ComparisonViewAreaFilterPipe.prototype.transform(this.area,this.areaLevel3,"GLO")[0]):null;

    if (this.areaLevel1 != null && this.areaLevel1.stateAvailable && this.state1 == null) {
      alert.setSubTitle("Select Area 1 - State");
      alert.present();
    }
    else if (this.areaLevel1 != null && this.areaLevel1.districtAvailable && this.district1 == null) {
      alert.setSubTitle("Select Area 1 - District");
      alert.present();
    }
    else if (this.areaLevel2 != null && this.areaLevel2.stateAvailable && this.state2 == null) {
      alert.setSubTitle("Select Area 2 - State");
      alert.present();
    }

    else if (this.areaLevel2 != null && this.areaLevel2.districtAvailable && this.district2 == null) {
      alert.setSubTitle("Select Area 2 - District");
      alert.present();
    }
    else if (this.areaLevel3 != null && this.areaLevel3.stateAvailable && this.state3 == null) {
      alert.setSubTitle("Select Area 3 - State");
      alert.present();
    }

    else if (this.areaLevel3 != null && this.areaLevel3.districtAvailable && this.district3 == null) {
    ...
    else if(selectedArea1===selectedArea2 || selectedArea2===selectedArea3 || selectedArea1===selectedArea3)
    {
      ...
      if(selectedArea1 && (selectedArea1.areaLevel.districtAvailable || selectedArea1.areaLevel.stateAvailable))
      {
        selectedParentArea1=this.area.filter(d=>d.code===selectedArea1.parentAreaCode)[0]
      }

      if(selectedArea2 &&( selectedArea2.areaLevel.districtAvailable || selectedArea2.areaLevel.stateAvailable))
      {
        selectedParentArea2=this.area.filter(d=>d.code===selectedArea2.parentAreaCode)[0]
      }


      if(selectedArea3 && (selectedArea3.areaLevel.districtAvailable || selectedArea3.areaLevel.stateAvailable))
      {
