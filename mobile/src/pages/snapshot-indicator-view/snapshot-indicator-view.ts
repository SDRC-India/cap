...
export class SnapshotIndicatorViewPage {
  ...
  setData(){
    ...
    this.siv.indicatorName = this.data.snapshotIndicator.indicator.name
    ...
    switch(this.data.snapshotIndicator.area.areaLevel.level){
    ...
    if(this.data.snapshotIndicator.area.areaLevel.level!=AreaLevel.DISTRICT)
    this.getMapViewData();
