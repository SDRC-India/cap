...
export class ConstantServiceProvider {
  ...
  getConstantObject() {
    const obj: IConstant = {
      ...
      // serverUrl: "https://devserver.sdrc.co.in/cap-backend/",
      //  serverUrl: "http://192.168.1.253:8080/cap/",
      // serverUrl:'https://testserver.sdrc.co.in:8443/cap-backend/',
      serverUrl:'https://uat.sdrc.co.in/cap-backend/',
